    ...
    render() {
        return (
            <span title="Click to copy a reference.">
                <a className="ddbx-copy-reference" href="javascript:void(0)" data-ref-content={this.buildReferenceContent()} onClick={this.copyReference} ref={(el) => this.jqRefButton = $(el)} />
