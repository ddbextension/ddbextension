...
/**
 * Parses the existing table content to ddbx dialog.
 * @param {*} tableHtml 
 */
...
class TinyMCETablesTab extends Component {
    ...
    render() {
        return (
            <div>
                <Form inline className="ddbx-content-panel ddbx-tables-tab">
                    <TextField
                    ...
                    />
                    <Button className="ddbx-tables-add-row" bsSize="xsmall" disabled={!this.isDiceExpPositive()} onClick={this.addRow}>Add Row</Button>
                    <div className="ddbx-tables-rows">
                        {this.renderRows()}
                    </div>
                    {this.renderMinMaxValue()}
                </Form>

                <ButtonToolbar className="ddbx-button-toolbar">
