...
class CharactersApp extends Component {
    ...
    componentDidMount() {
        ...
        if (!this.props.campaign) {
            ...
            ReactDOM.render(<CreateFolderButton buttonClasses="button-alt button-alt-character ddbx-create-folder-button" onCreateFolder={this.handleCreateFolder} />, temp, () => {
                $(".ddb-page-header .more-links .links").append(temp.children[0]);
            });

            const temp2 = document.createElement("div");
            ReactDOM.render(<CreateFolderButton buttonClasses="button ddbx-create-folder-button" onCreateFolder={this.handleCreateFolder} />, temp2, () => {
                $(".ddb-characters-listing-header-secondary").append(temp2.children[0]);
            });
        } else {
            const temp3 = document.createElement("div");
            ReactDOM.render(<CreateFolderButton buttonClasses="button-alt button-alt-default ddbx-create-folder-button" onCreateFolder={this.handleCreateFolder} />, temp3, () => {
